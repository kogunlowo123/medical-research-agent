"""Medical Research Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Medical research agent that searches clinical literature, summarizes research findings, identifies relevant clinical trials, analyzes study methodologies, and generates literature review summaries.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
