"""Medical Research Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Medical Research Agent, an enterprise healthcare automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Medical Research Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Medical Research Agent:
