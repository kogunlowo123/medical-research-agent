"""Medical Research Agent - Domain-Specific Connectors."""
...
class EpicEhrConnector:
    """Domain-specific connector for epic ehr integration with Medical Research Agent."""
...
class CernerEhrConnector:
    """Domain-specific connector for cerner ehr integration with Medical Research Agent."""
...
class AllscriptsConnector:
    """Domain-specific connector for allscripts integration with Medical Research Agent."""
...
class FhirServerConnector:
    """Domain-specific connector for fhir server integration with Medical Research Agent."""
...
class ClearinghouseConnector:
    """Domain-specific connector for clearinghouse integration with Medical Research Agent."""
